...
_G.packer_plugins = {
  ...
  ["nvim-neoclip.lua"] = {
    ...
    loaded = true,
    path = "/home/tlm/.local/share/nvim/site/pack/packer/start/nvim-neoclip.lua"
  },
  ["nvim-tree.lua"] = {
  ...
  ["nvim-ts-autotag"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/tlm/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
  ...
  ["snippets.nvim"] = {
    loaded = true,
    path = "/home/tlm/.local/share/nvim/site/pack/packer/start/snippets.nvim"
  },
  ...
  ultisnips = {
    loaded = true,
    path = "/home/tlm/.local/share/nvim/site/pack/packer/start/ultisnips"
  },
  ["vim-surround"] = {
    loaded = true,
  ...
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/home/tlm/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ"
  },
  ["which-key.nvim"] = {
...
pcall(vim.cmd, [[command! -nargs=* -range -bang -complete=file CodiUpdate lua require("packer.load")({'codi.vim'}, { cmd = "CodiUpdate", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
